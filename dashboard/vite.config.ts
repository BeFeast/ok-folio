...
// Single source of truth for the version shown in the About panel: the
// package.json `version` field, injected as a build-time constant so the UI
// never hardcodes a version literal.
